...
function getTotalPosts() {
    fetch('https://social-media-platform-system-production.up.railway.app/posts/analytics/posts')
      .then(response => response.json())
      .then(post => {

       
        let totalUsers = document.getElementById('totalPosts').innerText=post;
      })
